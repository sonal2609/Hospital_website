...
<script src="jquery.chained.min.js"></script>-->
    ...
    if (isset($_POST["user"]) && isset($_POST["pass"]))
    {
		...
		$sql="select * from reception where user='$username' and pass='$password'";
        ...
        if (mysqli_num_rows($result) == 1)
        {
            ...
            header("Location: http://$host$path/hosp.php");
            exit;
	...
	<div id="body">
		<div class="content">
			<div id="section">
				...
				<b>Enter administrative login credentials:</b> <span class="tagline"> </span>	
