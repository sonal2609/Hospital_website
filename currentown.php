...
<body>
	...
	<div id="body">
		<div class="section">
			<h2>Current Own Patients' list</h2>
<?php
	...
	if (mysqli_select_db( $conn, $db) === false)
	 ...
	 $var1=$_SESSION['var'];
		...
		$sql= "select * from patient as p inner join doctors as d on p.doctor=d.name and d.username='$var1' and p.d_date is NULL;";
		
	/*$sql= "select * from patient where d_date is NULL and doctor='$var1'";*/
